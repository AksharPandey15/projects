...
function Scene_Preloader(){
	...
	// NEW TITLE TEXT
	var titleLine1 = new PIXI.Text("ब्रेकिंग इंडिया:", {font:"bold 64px Poppins, sans-serif", fill:"#FFFFFF", align:"center"});
	titleLine1.anchor.x = 0.5;
	titleLine1.anchor.y = 0.5;
	titleLine1.x = 278;
	titleLine1.y = 50;
	Game.stage.addChild(titleLine1);

	var titleLine2 = new PIXI.Text("नफ़रत LIVE", {font:"bold 80px Poppins, sans-serif", fill:"#FFFFFF", align:"center"});
	titleLine2.anchor.x = 0.5;
	titleLine2.anchor.y = 0.5;
	titleLine2.x = 278;
	titleLine2.y = 130;
	Game.stage.addChild(titleLine2);
	...
	Game.loadAssets(function(){
		...
		bar.mousedown = bar.touchstart = function(){
