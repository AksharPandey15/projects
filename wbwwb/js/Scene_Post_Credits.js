...
function Scene_Post_Credits(){
    ...
    self.camera = new Camera(self,{
        ...
        onTakePhoto: function(){
            ...
            if(Game.sounds.bg_nighttime) Game.sounds.bg_nighttime.stop();
    ...
    var promptText = new PIXI.Text("Take 1 last picture...", {font:"22px Poppins, sans-serif", fill:"#AAAAAA", align:"center"});
    promptText.anchor.x = 0.5;
    promptText.anchor.y = 0.5;
    promptText.x = Game.width / 2;
    promptText.y = 50;
    promptText.alpha = 0;
    Game.stage.addChild(promptText);
    ...
    Tween_get(blackout).to({alpha:0}, _s(BEAT), Ease.quadInOut).call(function(){
        ...
        Tween_get(promptText).to({alpha:0.8}, _s(BEAT), Ease.quadInOut);
    });
