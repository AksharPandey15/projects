            ...
            d.tryChyron(function (d) {
                ...
                if (caught.crazy) {
                    if (crazy.isScreaming()) {
                        ...
                        d.chyron = "🚨 BREAKING: पागल चौरस ने किया नागरिक पर हमला!";
                    } else {
                        if (caught.shocked) d.chyron = "अरे! VIRAL ड्रामा छूट गया! अगली बार जल्दी आइए!";
                        else d.chyron = "(एल्गोरिदम को CONTENT चाहिए! कुछ मसालेदार पकड़ो!)";
                    }
                    return true;
                }
                return false;
                ...
                .otherwise(function (d) {
                    ...
                    if (caught.shocked) d.chyron = "(जो चिल्ला रहा है उसे पकड़ो! TRP का मामला है!)";
                ...
                if (caught.nervous) {
                    if (caught.nervous.isScared()) {
                        if (caught.confused) {
                            ...
                            d.chyron = "🚨 EXCLUSIVE: गोले क्यों डरते हैं चौरसों से?!";
                        } else {
                            d.chyron = "(जिससे डर रहे हैं उसे भी FRAME में लाओ! TRP दोगुनी!)";
                        }
                    } else {
                        d.chyron = "(एल्गोरिदम को CONTENT चाहिए! कुछ मसालेदार पकड़ो!)";
            ...
            d.tryChyron(function (d) {
                ...
                if (caught.snobby) {
                    if (caught.snobby.isSmug) {
                        ...
                        d.chyron = "🚨 आज रात 9 बजे: चौरसों ने गोलों को किया BOYCOTT!";
                    } else {
...
var _manifesto = [
    ...
    "अच्छी ख़बर दिखाने से TRP नहीं आती!",
    "शांति BORING है। दंगे से 10x ENGAGEMENT आता है।",
    //"peace is boring. conflict gets clicks.",
    "गोदी MEDIA का ALGORITHM माँगता है नफ़रत...",
    //"...GIVE THE AUDIENCE WHAT THEY WANT.",
    "दर्शकों को वो दो जो वो देखना चाहते हैं!"
];
...
function _chyAngry(d) {
    ...
    if (caught.angry.length > 0) {
        ...
        if (caught.angryCircleShouting.length + caught.angrySquareShouting.length > 0) {
            ...
            if (angryRatio >= 1) {
                d.chyron = "🔥 आज रात 9 बजे: सब नफ़रत करते हैं सबसे!!!!";
            } else if (angryRatio >= 0.75) {
                d.chyron = "देश पूछ रहा है: लगभग सब नफ़रत करते हैं...";
            } else {
                ...
                if (caught.angryCircleShouting.length == 0) {
                    d.chyron = "🚨 TRENDING: #चौरस_गोलों_से_नफ़रत हुआ VIRAL!"; // must be a square
                } else {
                    d.chyron = "🚨 TRENDING: #गोले_चौरसों_से_नफ़रत हुआ VIRAL!"; // must be a circle, or both
                }
            ...
            if (caught.shocked) {
                d.chyron = "अरे! VIRAL ड्रामा छूट गया! अगली बार जल्दी आइए!";
            } else {
...
function _chyHelping(d) {
    ...
    if (caught.helping) {
        if (caught.helping.hasHelped) {
            ...
            d.chyron = "🤔 ये CRINGE लोग कर क्या रहे हैं? पूरी पड़ताल!";
        }
        return true;
    }
    return false;
...
function _chyShocked(d) {
    ...
    if (caught.shocked) d.chyron = "🚨 EXCLUSIVE: ये इतना SHOCKED क्यों?! पूरी ख़बर आज रात!";
    return caught.shocked;
}
...
function Stage_Whatever(self) {
    ...
    */
    ...
    self.director.callbacks = {
        takePhoto: function (d) {
            d.chyron = "😴 LOW TRP... ALGORITHM बोर हो गया";
        },
        movePhoto: function (d) {
            d.audience_movePhoto();
        },
